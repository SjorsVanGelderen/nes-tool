...
pub struct PatternTable {
    ...
    // pub texture: Arc<ImmutableImage<Format>>, // TODO: Get these from a method
...
impl PatternTable {
    ...
    pub fn load_from_file(
        path: &Path, queue: Arc<Queue>, sampler: Arc<Sampler>
    ) -> (
        ...
        PatternTable::get_texture_and_future(queue.clone(), &pixels)
    }

    // TODO: Consider returning tex, tex_future and descriptor set all at once
    pub fn get_texture_and_future(queue: Arc<Queue>, pixels: &[u8; 32768]) -> (
        Arc<ImmutableImage<Format>>, CommandBufferExecFuture<NowFuture, AutoCommandBuffer>
    ) {
